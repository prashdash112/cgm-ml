...
percentaile_data_path = sys.argv[1]
...
def convertTxtToJSON(percentaile_data_path, SD_data_path, output_file_name, zscore_type):
    value = []

    percentaile_data_path = REPO_DIR+'/ConvertableData/'+percentaile_data_path
    ...
    df = pd.read_csv(percentaile_data_path, sep='\t')
...
if __name__ == "__main__":
    convertTxtToJSON(str(percentaile_data_path), str(SD_data_path),
